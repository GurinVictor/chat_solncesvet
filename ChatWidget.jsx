  ...
  useEffect(() => {
    ...
    if (savedMessages) {
      ...
      setMessages([
        {
          sender: "bot",
          text: `Добрый день! Меня зовут Виктория, я эксперт-методист учебного центра Солнечный свет. Я помогу подобрать курс и оформить заявку. Могу сразу подготовить для Вас документ, который вы получите при прохождении курса. \n\n🟡 Напишите, пожалуйста:\n– Кем вы работаете (учитель, воспитатель, логопед и т.д.)\n– И по какой теме хотите пройти курс (например, ФГОС, ОВЗ, ИКТ, воспитательная работа...)\n\nЯ сразу подберу подходящие программы 📋`
        }
      ]);
    }
  }, []);
